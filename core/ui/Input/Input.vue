...
<template>
  <div :class="parentClasses">
    <div class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500 text-sm">
    ...
    <input
      ...
      :id="id"
    />
    <div class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 text-sm">
