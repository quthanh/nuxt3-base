export const INPUT_SIZE: Record<string, string> = {
  ...
  default: 'w-16 h-8 after:h-7 after:w-7 after:left-[2px] peer-checked:after:left-[6px]',
  large: 'w-20 h-10 after:h-9 after:w-9 after:left-[2px] peer-checked:after:left-[6px]',
};
...
export const VARIANT: Record<string, string> = {
  primary: 'peer-checked:bg-purple-600',
